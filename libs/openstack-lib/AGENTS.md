...
│   └── workflows/
├── crczp/
│   └── openstack_driver/        # Core Python package source
│       └── *.py                 # OpenStack client classes
├── AGENTS.md                    # This file
├── LICENSE
...
* **`crczp/openstack_driver`** contains all production Python code for OpenStack client classes

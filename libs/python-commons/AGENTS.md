...
│   └── workflows/
├── crczp/
│   └── cloud_commons/           # Core Python package source
│       └── *.py                 # Common cloud client classes
├── AGENTS.md                    # This file
├── LICENSE
...
* **`crczp/cloud_commons`** contains all production Python code for common cloud client classes
